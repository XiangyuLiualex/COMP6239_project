...
//                    onConfirm = { optionName ->
////                        buttons = listOf(optionName) + buttons
//                        elements += ButtonElement(optionName)  // 在列表末尾添加新的按钮元素
//                        showForm = false
//                    }
//                )
//            }
...
//            when (element) {
//                is TextFieldElement -> RemovableTextField(
//                    text = element.text,
//                    onTextChange = { newText -> element.text = newText },
//                    onRemove = { elements = elements - element }
//                )
//                is ButtonElement -> OptionButton(
...
//                    text = { Text("Text") },
//                    onClick = {
//                        elements += TextFieldElement()  // 添加新的空字符串表示新输入框
//                        expanded = false
//                    },
//                    leadingIcon = {
//                        Icon(Icons.Outlined.Edit, contentDescription = null)
...
//data class TextFieldElement(var text: String = "") : Element()
//data class ButtonElement(var optionName: String) : Element()